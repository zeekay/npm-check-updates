...
function analyzeProjectDependencies(pkgData, pkgFile) {
    ...
    // get a list of the current dependencies, filtered by any specified options such as dev/prod/filter
    ...
    // filter out non-npm dependencies (e.g. github tags)

    current = cint.filterObject(current, function (dep, version) {
        return vm.isValid(version);
    });
